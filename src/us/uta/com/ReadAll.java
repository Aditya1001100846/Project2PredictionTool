...
public static void main(String args[])  {  
 try{  
  ...
  String inputfile = "/home/aditya/java-spring/fileLocation/TestData/jobs.tsv"; //  Source File Name.  
  double nol = 50000.0; //  No. of lines to be split and saved in each output file.  
